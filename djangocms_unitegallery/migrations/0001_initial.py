    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mp4video',models.TextField(blank=True, help_text="Leave this blank if you don't want to display a video.", verbose_name='MP4 video url')),
                ('youtubevideo',models.TextField(blank=True, help_text="Leave this blank if you don't want to display a YouTube video.", verbose_name='YouTube video id')),
            ],
        ),
    ]
